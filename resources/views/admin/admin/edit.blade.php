...
<x-app-layout>
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-md rounded-2xl p-6">
            <h2 class="text-2xl font-bold mb-6 text-gray-700">Edit Admin</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="username" value="{{ old('username', $admin->user->username) }}"
                            readonly class="mt-1 block w-full rounded-lg bg-gray-100 border-gray-300 shadow-sm">
                    </div>

                    <div x-data="{ show: false }">
                        <label class="block text-sm font-medium text-gray-700">Password <span
                                class="text-gray-400 text-xs">(kosongkan jika
                                tidak ingin ubah)</span></label>
                ...
                <div x-data="{
                    ...
                    <div class="relative flex flex-col items-center justify-center w-full p-6 border-2 border-dashed rounded-2xl cursor-pointer transition hover:border-indigo-400 hover:bg-indigo-50"
                        ...
                        <div class="flex flex-col items-center text-gray-500">
                            ...
                            <span class="text-sm">Klik untuk upload foto baru</span>
