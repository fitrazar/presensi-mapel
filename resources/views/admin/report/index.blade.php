...
<x-app-layout>
    <div class="py-10 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-md rounded-2xl p-6 mb-6 flex flex-col md:flex-row md:items-end gap-4">
            <form method="GET" action="{{ route('admin.report.index') }}" class="flex flex-wrap gap-4">
                <div>
                ...
                <div>
                    ...
                    <select name="grade_id" class="border rounded-lg px-3 py-2 w-48">
            ...
            <div class="flex gap-3 ml-auto">
                <form method="GET" action="{{ route('admin.report.exportExcel') }}">
                ...
                <form method="GET" action="{{ route('admin.report.exportPdf') }}">
                    <input type="hidden" name="start_date" value="{{ $start_date }}">
                    <input type="hidden" name="end_date" value="{{ $end_date }}">
                    <input type="hidden" name="grade_id" value="{{ $grade_id }}">
